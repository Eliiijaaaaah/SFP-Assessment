...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  computed: {
    currentGenre: function currentGenre() {
      ...
      return this.genres.find(function (genre) {
        return genre.id == _this.currentGenreId;
      });
    }
  }
});
    ...
    _c("section", { staticClass: "hero" }, [
      _c("div", { staticClass: "hero-text" }, [
        _c("h1", {
          ...
          domProps: { textContent: _vm._s(_vm.currentGenre.name) }
        }),
        _vm._v(" "),
        _c("a", { attrs: { href: "#movies" } }, [_vm._v("View List")])
      ])
    ]),
    _vm._v(" "),
    _c(
      ...
      [
        ...
        _vm._v(" "),
        _c("grid", { attrs: { genre: _vm.currentGenreId } })
      ],
      1
    )
  ])
...
var render = function() {
  ...
  return _c("div", { staticClass: "movie" }, [
    ...
    _c("p", { staticClass: "rating" }, [
      _vm._v("Average Rating: " + _vm._s(_vm.rating))
    ])
  ])
}
var staticRenderFns = []
...
__webpack_require__(/*! C:\Users\Elijah\Desktop\SFP Assessment\sfp-frontend-assessment\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! C:\Users\Elijah\Desktop\SFP Assessment\sfp-frontend-assessment\resources\scss\app.scss */"./resources/scss/app.scss");
